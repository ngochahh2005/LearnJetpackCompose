...
fun MyAccountScreen(navController: NavController, openAddressScreen: (String?) -> Unit) {
    ...
    //kiem tra neu trong backstack co new_address_id thi lay ra va gan cho addressId
    val newAddressId = navController.currentBackStackEntry?.savedStateHandle?.getLiveData<String>("new_address_id")?.observeAsState()
